...
class ClientCredentialIssuerTest extends TestCase
{
    ...
    public function testIssueGeneratesUuidV4ClientIdAndHashesSecret(): void
    {
        ...
        $result = $this->issuer->issue('mycli', ['https://example/cb'], ['catalog.product.get']);
    ...
    public function testIssueRejectsEmptyName(): void
    {
        ...
        $this->issuer->issue('', ['https://example.com/cb'], ['catalog.product.get']);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->issuer->issue('test', [], ['catalog.product.get']);
    }

    public function testIssueRejectsHttpNonLocalhostRedirect(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->issuer->issue('test', ['http://example.com/cb'], ['catalog.product.get']);
    }

    public function testIssueRejectsRedirectWithQueryString(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->issuer->issue('test', ['https://example.com/cb?source=foo'], ['catalog.product.get']);
    }

    public function testIssueRejectsRedirectWithFragment(): void
    {
        $this->expectException(InvalidArgumentException::class);
        $this->issuer->issue('test', ['https://example.com/cb#bar'], ['catalog.product.get']);
    }
    ...
    public function testIssueAcceptsHttpLocalhost(): void
    {
        ...
        $result = $this->issuer->issue('test', ['http://localhost:3000/cb'], ['catalog.product.get']);
    ...
    public function testIssueAcceptsHttp127001(): void
    {
        ...
        $result = $this->issuer->issue('test', ['http://127.0.0.1:8080/cb'], ['catalog.product.get']);
        self::assertArrayHasKey('client_id', $result);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->issuer->issue('test', ['not-a-url'], ['catalog.product.get']);
    }
