...
interface RefreshTokenInterface
{
    ...
    public const PARENT_REFRESH_TOKEN_ID = 'parent_refresh_token_id';
    ...
    /**
     * The refresh token this row was rotated from. Null on the first refresh issued for a grant.
     * Used to walk the rotation chain when OAuth 2.1 §6.1 reuse is detected so the entire chain
     * downstream of the reused token can be revoked in one pass.
     *
     * @return int|null
     */
