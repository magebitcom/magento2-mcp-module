...
/**
 * One row in magebit_mcp_audit_log; arguments are PII-redacted and size-capped, responses are summarized (never full body).
 */
interface AuditEntryInterface
{
    ...
    public const PROMPT_NAME = 'prompt_name';
