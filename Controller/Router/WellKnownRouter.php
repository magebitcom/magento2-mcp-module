 ...
 *
 * Mirrors `Magento\Securitytxt\Controller\Router` — exact-string match on the
 * trimmed path-info, controller resolved via {@see ActionList} so future DI
 * preferences/virtualtypes are respected.
 */
